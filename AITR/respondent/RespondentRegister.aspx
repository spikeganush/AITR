    ...
    <div class="survey__card">
        ...
        <div class="register__respondent__area">
            <div class="register__respondent__line">
                ...
                <asp:TextBox class="field" ID="TextBoxFirstName" runat="server" />
            ...
            <div class="register__respondent__line">
                ...
                <asp:TextBox class="field" ID="TextBoxLastName" runat="server" />
            ...
            <div class="register__respondent__line">
                ...
                <asp:TextBox class="field" ID="TextBoxPhoneNumber" runat="server" />
        ...
        <div class="register__buttons">
            <a href="../Home.aspx" style="text-decoration: none;">
                <input id="cancel_registration" type="button" value="Cancel" />
            </a>
