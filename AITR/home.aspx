...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <div class="survey__card">
        <div class="header">
            ...
            <a href="./staff/Login.aspx"><input id="staff" type="button" value="Staff Login" /></a></div>
        ...
        <div class="start_button_area"><a href="./respondent/StartSurvey.aspx">
            <input id="start_survey" type="button" value="Start the survey" /></a></div>
    </div>
</asp:Content>
